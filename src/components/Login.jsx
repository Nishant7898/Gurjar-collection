...
const Login = ({ isOpen, onClose, onSwitchToSignup }) => {
  ...
  const handleSubmit = () => {
    ...
    if (phoneRegex.test(identifier)) {
      key = `user_${identifier}`;
    } else if (emailRegex.test(identifier)) {
      key = identifier;
    } else {
      alert("Enter a valid 10-digit phone number or email address");
      return;
    }
    ...
    alert(`Welcome back, ${userData.Name || "User"}! Login successful.`);
    onClose();
  };
    ...
    >
      ...
      <div className="p-8 text-center items-center justify-center mt-12">
        ...
        <div className="space-y-4">
          <div className="text-left">
            ...
            <input
              ...
              placeholder="Enter your Number or Email Address"
              value={identifier}
        ...
        <div className="mt-6">
          ...
          <button className="w-full cursor-pointer mt-4 bg-white text-gray-800 py-3 px-4 rounded-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 focus:ring-offset-black transition-all font-medium flex items-center justify-center gap-2">
