...
import TshirtData from "../ClothesData(M)/Tshirt";
...
const Tshirt = () => {
  ...
  // Filter logic
  const filtered = TshirtData.filter((item) => {
  ...
  return (
    <div className="min-h-screen px-4 py-30">
      ...
      {/* Product Grid */}
      <div className="grid grid-cols-2 w-full md:px-50 px-4 md:grid-cols-4 gap-6">
